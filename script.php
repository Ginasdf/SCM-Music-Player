...
init:function(dataStr){
	...
	echo str_replace("script.php","",$_SERVER["SCRIPT_NAME"]); 
	
	?>container.php?url='+ escape( location.href.replace(/scmplayer\=true/g, 'scmplayer=false')) +'&place='+this.data.placement+'&showplaylist='+this.data.showplaylist;
